        ...
        <div className="productscreen">
            ...
            <div className="productscreen_left">
                ...
                <div className="left_info">
                    ...
                    <p className="left_name">Price: $15.000</p>
                    <p className="left_name">Description: Lorem impsum dolor sit amet consectetur adipisicing elit. Eaque voluptatum omnis ipsum commodi nesciunt.</p>
                </div>
            </div>
